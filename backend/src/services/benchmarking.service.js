  ...
  "winning_analysis": [
    {
      ...
      "why_it_won": "단순한 해시태그 말고, 이 문장이 프린스턴 대학교 연구 등 최신 GEO 최적화 알고리즘 7대 논리 중 정확히 무엇(예: 유창성, 구체적 통계, 출처)을 충족시켜 가시성을 얻었는지 마케터에게 '아하 모먼트!'를 줄 수 있는 명확한 근거 2문장",
      "our_counter_strategy": "자사 본문에 기반하여 AI가 우선순위로 채택할 만한 수치+팩트 기반의 초정밀 카운터 문구. (절대 주의사항: 뻔한 스펙 나열이나 가격/리뷰 추가를 앵무새처럼 반복하지 마세요! 자사 웹사이트에 이미 있는 걸 추가하라고 지어내지 말고, 완전히 비어있는 최적화 포인트(Pain Point)를 예리하게 찔러서 문장 구조 자체를 리빌딩하세요.)"
    }
  ]
}`;
